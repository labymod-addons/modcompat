package net.labymod.addons.modcompat.v1_20_1.mixins.modmenu.gui.widget;
...
public class MixinDescriptionListWidget {
  ...
  @Redirect(method = "render", at = @At(value = "INVOKE", target = "Lcom/mojang/blaze3d/vertex/Tesselator;end()V"))
