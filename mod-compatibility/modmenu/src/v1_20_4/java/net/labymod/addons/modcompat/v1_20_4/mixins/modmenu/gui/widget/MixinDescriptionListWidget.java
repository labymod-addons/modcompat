package net.labymod.addons.modcompat.v1_20_4.mixins.modmenu.gui.widget;
...
public class MixinDescriptionListWidget {
  ...
  @WrapOperation(method = "renderList", at = @At(value = "INVOKE", target = "Lcom/mojang/blaze3d/vertex/Tesselator;end()V"))
