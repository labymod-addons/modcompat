...
import net.labymod.addons.modcompat.v1_8_9.skyblockaddons.configuration.settings.SkyblockAddonsSettingCreator;
...
public class VersionedSkyblockAddonsEntrypoint extends ModFixEntrypoint {
  ...
  private List<Setting> createGeneralSettings(Config config) {
    return List.of(
